...
private [fs2pubsub]trait SubscriberFs2Grpc[F[_]] {
...
private [fs2pubsub]object SubscriberFs2Grpc {
  def stub[F[_]: _root_.cats.effect.ConcurrentEffect](channel: _root_.io.grpc.Channel, callOptions: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT): SubscriberFs2Grpc[F] = new SubscriberFs2Grpc[F] {
    def createSubscription(request: com.google.api.pubsub.Subscription, clientHeaders: _root_.io.grpc.Metadata): F[com.google.api.pubsub.Subscription] = {
